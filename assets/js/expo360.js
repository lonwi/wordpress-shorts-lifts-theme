/*! Copyright (c) 2013 Brandon Aaron (http://brandon.aaron.sh)i
...
function buttonsClass(classButton, normal, over, width, height, tweenTime) {
	var $button = jQuery(classButton);
	//NEXT OVER
	var $span = jQuery('<span class="hover"></span>');
	$button.append($span);
...
jQuery(document).ready(function ($){
    ...
    Expo360obj.prototype = {
    	...
    	parseXml: function(xml){
			...
			this.imagesArraySrc = this.parameters.imgArray;
			this.imagesArraySrcBig = this.parameters.imgArrayBig;
			this.imagesSrc = this.parameters.imgArrayName;
			
			if(this.imagesArraySrc.length == 1)
    	...
    	loadImage: function (num){
    		...
    		img.src = (this.imagesArraySrc[num]);
    	},
    	///////////////////////////////////////////////
    	...
    	loadBigImage: function (){
    	    if(!this.dragging && this.focusable){
        		...
        		img.src = (this.imagesArraySrcBig[num]);
    		}
    	},
    	///////////////////////////////////////////////
