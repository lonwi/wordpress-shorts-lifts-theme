...
if ( ! wc_ship_to_billing_address_only() && get_option( 'woocommerce_calc_shipping' ) !== 'no' ) {
	$page_title = apply_filters( 'woocommerce_my_account_my_address_title', __( 'Address Information', 'woocommerce' ) );
...
<?php foreach ( $get_addresses as $name => $title ) : ?>
	...
	<div class="col-<?php echo ( ( $col = $col * -1 ) < 0 ) ? 1 : 2; ?> address">
        <h3 class="title-small"><?php echo $title; ?></h3>
		<div class="address">
			<p><?php
				$address = apply_filters( 'woocommerce_my_account_my_address_formatted_address', array(
					...
					'branch'      => get_user_meta( $customer_id, $name . '_branch', true ),
        ...
        <p><a href="<?php echo wc_get_endpoint_url( 'edit-address', $name ); ?>" class="button small"><?php _e( 'Edit', 'woocommerce' ); ?></a></p>
	</div>
